...
console.log(yourAgeInSeconds(29));
...
function findMax(numbers) {
  ...
  // let the max number be the first number in the array
  // numbers[i] it means current number
  // if statments only run when something is true
  // numbers.length is the lenght of the array, so, its says, if the i is less than the array, keep incrementing i
